...
public class HotelService {
    ...
    public HotelDto mapToHotelDto(Hotel hotel) {
        ...
        return HotelDto.builder()
                ...
                .city(loc != null && loc.getCity() != null ? loc.getCity() : "Unknown")
                .state(loc != null ? loc.getState() : null)
                .country(loc != null && loc.getCountry() != null ? loc.getCountry() : "India")
                .area(loc != null ? loc.getArea() : null)
                .landmark(loc != null ? loc.getLandmark() : null)
